...
const DashboardPage = () => {
    ...
    return (
      <div className='min-h-screen bg-linear-to-br from-slate-50 via-white to-slate-50 flex items-center justify-center'>
        <div className='text-center'>
          ...
          <p className='text-slate-400 text-sm '>No dashboard data is available.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className='min-h-screen'>
      <div className='absolute inset-0 bg-[radial-gradient(#5e7eb_1px, transparent_1px)] bg-size-[16px_16px] opacity-30 pointer-events-none'/>
