...
import { ArrowLeft, CheckCircle2, XCircle, Trophy, Target, BookOpen, CheckCircle } from 'lucide-react';
  ...
  return(
    ...
    <PageHeader title={`${quiz.title || 'Quiz'} Results`} />
              ...
              {result.explanation && (
                <div className="p-4 bg-linear-to-br from-slate-50 to-slate-100/50 border border-slate-200 rounded-xl">
                  <div className="flex items-start gap-3">
                    <div className="shrink-0 w-8 h-8 rounded-lg bg-slate-50 border border-slate-200 flex items-center justify-center mt-0.5">
      ...
      <div className='mt-8 flex justify-center'>
        <Link
         to={`/documents/${quiz.document._id}`}>
         <button className='group relative px-8 h-12 bg-linear-to-r from-emerald-500 to-teal-500 text-white font-semibold text-sm rounded-xl  hover:from-emerald-600 hover:to-teal-600 transition-all duration-200 shadow-lg shadow-emerald-500/25 active:scale-95 overflow-hidden'>
