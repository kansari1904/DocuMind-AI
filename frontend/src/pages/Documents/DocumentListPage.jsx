      ...
      {isUploadModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
          <div className="relative w-full max-w-lg bg-white/95 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-2xl shadow-slate-900/20 p-8">
            ...
            {/* Modal Header */}
            <div className="mb-6">
              <h2 className="text-xl font-mono text-slate-900 tracking-tight">
                Upload New Document
              </h2>
            ...
            {/* Form */}
            <form
              onSubmit={handleUpload} className="space-y-5">
              {/* Title Input */}
...
{isDeleteModalOpen && (
    <div className="fixed inset-0 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
      <div className="relative w-full max-w-md bg-white/95 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-slate-900/2 p-8">
        {/* Close button */}
        <button
