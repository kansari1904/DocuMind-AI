    ...
    <div className="mt-6 pt-4 border-t border-slate-100">
        <button
            ...
            handleStudyNow();
                ...
                className="group/btn relative w-full h-11 bg-linear-to-r from-emerald-50 to-teal-50 border border-emerald-200 hover:from-emerald-600 hover:to-teal-600 text-emerald-700 hover:text-white font-semibold rounded-xl text-sm transition-all duration-200 active:scale-95 overflow-hidden"
        >
