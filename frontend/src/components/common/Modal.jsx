...
const Modal = ({ isOpen, onClose, title, children }) => {
    ...
    return <div className = "fixed inset-0 z-50 overflow-y-auto">
       ...
       <button
        onClick={onClose}
        className="absolute top-6 right-6 w-8 h-8 flex items-center justify-center rounded-lg text-slate-400 hover:text-slate-600 hover:bg-slate-100 transition-all divide-red-200"
        >
