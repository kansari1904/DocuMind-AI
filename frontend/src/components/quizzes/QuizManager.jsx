        ...
        <div className="bg-white border border-neutral-200 rounded-lg p-6">
         ...
         { renderQuizContent() }
            ...
            <Modal
                ...
                >
                <form
                onSubmit={handleGenerateQuiz} className="space-y-4"
                >
                <div>
            ...
            <Modal
                ...
                <div className="space-y-4">
                    <p className="text-sm text-neutral-600">
                        Are you sure you want to delete the quiz: <span className="text-semibold text-neutral-900">{selectedQuiz ?.title || 'this Quiz'}</span>? This action cannot be undone.
                    </p>
                    <div className="flex justify-end gap-2 pt-2">
                        <Button
                            type="button"
